...
def draw_smile(x, y, color):
    ...
    sd.line(point1, point2, sd.COLOR_DARK_ORANGE)
    ...
    for i in range(x - SMILE_SIZE, x + SMILE_SIZE + 1, step):
        ...
        sd.line(point_start, point_end, BEARD_COLOR)
    ...
    for i in range(x-smile_length, x+smile_length+1, step):
        ...
        sd.line(point_start, point_end, sd.COLOR_RED)


# рисуем смайлы
for _ in range(1):
    rnd_point = sd.get_point(300, 300)
